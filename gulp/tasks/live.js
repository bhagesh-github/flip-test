...
gulp.task('copyassets', function(done) {
  ...
  return gulp.src([
      ...
      '!app/en/images/**/*.png',
      '!app/en/images/**/*.jpg',
      '!app/en/styles/scss/*.*', //Ar
      // '!app/ar/index.html',
      '!app/ar/components/**/*.*',
      '!app/ar/masterpage/**/*.*',
      '!app/ar/pages/**/*.*',
      '!app/ar/scripts/common.js',
      '!app/ar/scripts/main.js',
      '!app/ar/scripts/routing.js',
      '!app/ar/images/**/*.png',
      '!app/ar/images/**/*.jpg',
      '!app/ar/styles/scss/*.*',
      '!app/**/*.zip',
...
gulp.task('imagesar', function(done) {

  return gulp.src([
      'app/ar/images/**/*.{jpg,png}'
    ])
    .pipe(imagemin({
      progressive: true,
      svgoPlugins: [{
    ...
    .pipe(gulp.dest('assets_live/ar/images/'))
});
...
gulp.task('htmlar', function(done) {
  return gulp.src('app/*.html')
        .pipe(useref())
        .pipe(gulp.dest('assets_live/ar/'));
});

gulp.task('live', ['copyassets', 'imagesen', 'imagesar'], function() {

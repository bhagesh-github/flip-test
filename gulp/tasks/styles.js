...
gulp.task('styles', function() {
  ...
  var scssLocation = isAr ? 'app/en/styles/scss/*.scss': props.pageScss;
  var stylesLocation = isAr ? 'app/en/styles': props.styles;
  ...
  return gulp.src(scssLocation)
    ...
    .pipe($.if(isAr, postcss(processors)))
    .pipe($.if(isAr, rtlcss()))
    .pipe($.autoprefixer({
      browsers: props.autoPrefix
    }))

...
var projPaths = {
  ...
  get distLang() {
    return path.join('dist', this.lang);
  },
  get styles() {
    return path.join('app', this.lang, 'styles');
  },
  get scssFolder() {
    return path.join('app', this.lang, 'styles', 'scss');
  },
  get scssFolderEn() {
  ...
  get scriptsEn() {
    return path.join('app', 'en', 'scripts');
  },
  get scss() {
    return path.join('app', this.lang, '**', '*.scss');
  },
  get mainScss() {
    return path.join('app', this.lang, 'styles', 'scss', 'main.scss')
  },
  get pageScss() {
    return path.join('app', this.lang, 'styles', 'scss', '*.scss')
  },
  get compFolder() {
    return path.join('app', 'en', 'components')
  },
  get compScss() {
    return path.join('app', this.lang, 'components', '**', '*.scss')
  },
  get html() {
  ...
  get spriteSvg() {
    return path.join('app', this.lang, 'images', 'icons-svg', '*.svg')
  },
  get imagesFolder() {
